  ...
  <div>
    ...
    <div style="height:150px; background-color:#505763">
      <div class="container text-white">
        <h2 class="pt-5 text-center">Personalize Interview Questions</h2>
        <p class="pt-4 text-center">All Questions</p>
      </div>
    </div>
    ...
    <div v-else>
      <div
        ...
        v-if="interview && interview.interviewArray.length != 0"
      >
        <!-- <h4 class="my-5 text-center">
        <u><strong>Your interviews</strong> </u>
      </h4> -->
        <div class="row">
          <div
            class="my-3 col-md-4 d-flex justify-content-center"
            :key="index"
            v-for="(t, index) in interview.interviewArray"
          >
            <div class="rounded card ">
              <img
                class="img-fluid border-bottom border-secondary"
                style="height:150px"
                :src="t.interviewDetails.imgUrl"
                alt="Card image cap"
              />
              <div class="card-body ">
                <h6 class="card-title">
                  <strong>{{ t.interviewDetails.topicName }}</strong>
                </h6>
                <p class="card-text">
                  {{ t.interviewDetails.summary }}
                </p>
                ...
                >
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      ...
                      <iframe
                        :src="t.interviewDetails.link + '#toolbar=0'"
                        height="500px"
                      >
                      </iframe>
                    </div>
...
export default {
  ...
  methods: {
    ...
    async getinterviews() {
      ...
      await axios({
        method: "GET",
        url: this.$store.state.courseApi.getInterviews + "/" + this.type,
        headers: { authorization: val },
      }).then((val) => {
        console.log(val);
        this.interview = val.data;
        console.log(this.interview);
        // this.interview.interviews.forEach(async (t) => {
        ...
        // this.getEndDates();
        // console.log(new Date(this.interview.registerAt));
        // this.interview.forEach(t => {
    ...
    //   var regDate = new Date(this.interview.mobRegisterAt);
    //   // var d = new Date("2021-02-04 01:02:49");
    //   var startDate = regDate.setDate(
    //     regDate.getDate() + (parseInt(item) - 1) * 7
    //   );

    //   var endsDate = new Date(this.interview.mobRegisterAt);
    ...
    //   // var date = this.interview.registerAt[0] + this.interview.registerAt[1];

    //   // var month = this.interview.registerAt[3] + this.interview.registerAt[4];

    //   // var year =
    //   //   this.interview.registerAt[6] +
    //   //   this.interview.registerAt[7] +
    //   //   this.interview.registerAt[8] +
    //   //   this.interview.registerAt[9];
